...
The goal of layers is to provide a simple library for doing common reinsurance calculations.

## Installation

You can install the released version of `layers` from [GitHub](https://github.com/) with:
